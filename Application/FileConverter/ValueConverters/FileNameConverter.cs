...
namespace FileConverter.ValueConverters
{
    ...
    public class FileNameConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException("The values must contains the input file path, the output file extension, the ouput file template and optionally the preset name.");
            }
            ...
            return PathHelpers.GenerateFilePathFromTemplate(inputFilePath, outputFileExtension, outputFileTemplate, 1, 3, presetName);
        }
